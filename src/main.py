...
class RAGPipeline:
    def __init__(self, data_path: str, index_path: str):
        ...
        self.upsell_links = {
            "suspension": "https://url/store/suspension?sort=instock&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "tires": "https://url/store/tires?tiresOnly=true&diameter_from=18&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}&sort=popular",
            "wheels": "https://url/store/wheels?sort=instock&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "wheels-tires-package": "https://url/store/wheels?sort=instock&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "bed-accessories": "https://url/store/exterior-accessories/bed-accessories?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "engine-performance": "https://url/store/performance/engine-performance?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "intake": "https://url/store/performance/intake?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "driveline": "https://url/store/performance/driveline?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "brakes": "https://url/store/performance/brakes?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "exhaust": "https://url/store/performance/exhaust?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "tuners-and-gauges": "https://url/store/performance/tuners-and-gauges?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "lighting-accessories": "https://url/store/lighting/lighting-accessories?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "exterior-lighting": "https://url/store/lighting/exterior-lighting?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "interior-lighting": "https://url/store/lighting/interior-lights?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "off-road-lighting": "https://url/store/lighting/off-road-lighting?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "auxiliary-lighting": "https://url/store/lighting/auxiliary-lighting?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "armor-and-protection": "https://url/store/exterior-accessories/armor-and-protection?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "body": "https://url/store/exterior-accessories/body?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "bumpers-and-accessories": "https://url/store/exterior-accessories/bumpers-and-accessories?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "horns": "https://url/store/exterior-accessories/horns?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "overlanding-and-camping": "https://url/store/exterior-accessories/overlanding-and-camping?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "safety-and-storage": "https://url/store/exterior-accessories/safety-and-storage?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "step-bars": "https://url/store/exterior-accessories/step-bars?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "towing": "https://url/store/exterior-accessories/towing?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "winches-and-recovery": "https://url/store/exterior-accessories/winches-and-recovery?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "interior-protection-and-storage": "https://url/store/interior-accessories/interior-protection-and-storage?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "interior-safety": "https://url/store/interior-accessories/interior-safety?sort=quick%20delivery&year={year}&make={brand}&model={model}&trim={trim}&drive={drive_type}",
            "seats": "https://url/store/interior-accessories/seats?subcategory=Seats"
        }
